...
<head>
    ...
    @section('content')
        ...
        <html>
        <br>
        <div><!--select vacation from database for  Manager that  rejected   -->
...
;
                    ...
                    @foreach ($Vacations as $Vacation)
                        <tr>
                            ...
                            <td><a href = 'UpdateApprovalM/{{ $Vacation->id }}'>Update</a></td>
            ...
            <form action="/massagge">
                ...
                <table class="table table-sm table-primary">
                    ...
                    $Permissions = DB::table('permmision')
                        ...
                        ->where('permmision.status','Reject')
                        ->where('users.Manager',$name)
        ...
        <!--select vacation from database for top  Manager that  rejected   -->

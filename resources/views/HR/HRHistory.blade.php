...
h.HRname,u.vacationsbalance
                              from holidays h,users u where h.name= u.name   ORDER BY h.creation DESC');//  عرض البيانات للعام ال\ى نحن فيه
                        ?>
                        <thead >
...
,h.HR,u.permissionshours
                              from permmision h,users u where h.name= u.name and h.status=?  ORDER BY h.creation DESC',[$as]);//  عرض البيانات للعام ال\ى نحن فيه
                        ?>
                        <thead >
                        <tr class="bg-info" ><!-- header-->
                            <td>Id</td>

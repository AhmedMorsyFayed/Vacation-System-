                ...
                <div >
                    ...
                    <table id="table_format" class="table table-bordered table-striped table-hover table-list-search">
                        ...
                        <tr class="bg-info " ><!-- header -->
                            <td id="a" style="width: 3%;font-size: 22px">المسلسل</td>
                            <td id="b" style="width: 3%;font-size: 22px">النوع</td>
                            <td id="c" style="width: 50%;font-size: 22px">الوصف</td>
                            <td id="d" style="width: 10%;font-size: 22px">التاريخ</td>
                            <td id="f" style="width: 30%;font-size: 22px"> <center>القرار</center></td>
                        ...
                        @foreach ($Suggests as $Suggest)
                            <tr>
                                <td id="a" style="width: 3% ;">{{ $Suggest->id }}</td>
                                <td id="a" style="width: 3% ;font-size: 22px">{{ $Suggest->Type }}</td>
                                <td id="a" style="width: 50%;font-size: 22px">{{ $Suggest->description }}</td>
                                <td id="a" style="width: 10%;">{{ $Suggest->Creation }}</td>
                                <td id="a" style="width: 30%;"></td>

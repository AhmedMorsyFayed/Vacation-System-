<?php
//Report about excel sheet about vacations and permissions for Topmanager
...
class TopManPer implements FromQuery,WithHeadings,ShouldAutoSize , WithEvents
{
    /**
    ...
    public function query()// sql getting the information about employee for TopManager
    {
